...
function imgurl(p1) {
  if (p1 === undefined){
    ...
    return p1.replace("./", "https://janklostermann.github.io/");
  } else if (p1.indexOf("/") === 0) {
    return p1.replace("/", "https://janklostermann.github.io/");
  } else {
    return p1
...
const hitTemplate = function(hit) {
  ...
  return `
          ...
          <div class="row">
          <div class="col">
          <h5 class="chulapa-links-hover-only"><a href="https://janklostermann.github.io/${url}">${title}</a></h5>
          </div>
          </div>
          <div class="row mt-2">
          <div class="col">
    ...
    <article class="my-2 text-left">
      ...
      <a href="https://janklostermann.github.io/${url}">
